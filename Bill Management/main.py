...
lbl_coffe = Label(f1, font=("arial",20,"bold"), text="Coffe", width=12, fg="blue4")
lbl_juice = Label(f1, font=("arial",20,"bold"), text="Juice", width=12, fg="blue4")
lbl_pancake = Label(f1, font=("arial",20,"bold"), text="Pancake", width=12, fg="blue4")
...
entry_pancake = Entry(f1, font=("arial",20,"bold"), textvariable=pancakes, bd=6, width=8, bg="lightpink")
...
entry_coffe.grid(row=4, column=1)
